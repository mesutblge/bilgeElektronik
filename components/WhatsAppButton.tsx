...
async function handleWhatsAppClick(e: React.MouseEvent<HTMLAnchorElement>) {
  ...
  window.open('https://wa.me/905427963140?text=Merhaba%2C%20tamir%20hakk%C4%B1nda%20bilgi%20almak%20istiyorum.', '_blank', 'noopener,noreferrer')
}
  ...
  return (
    ...
    >
      ...
      >
        ...
        <path d="M12 0C5.373 0 0 5.373 0 12c0 2.127.558 4.126 1.533 5.859L.057 23.535a.75.75 0 00.906.919l5.857-1.53A11.945 11.945 0 0012 24c6.627 0 12-5.373 12-12S18.627 0 12 0zm0 21.75a9.714 9.714 0 01-4.964-1.362l-.355-.212-3.68.961.983-3.595-.232-.371A9.712 9.712 0 012.25 12C2.25 6.615 6.615 2.25 12 2.25S21.75 6.615 21.75 12 17.385 21.75 12 21.75z" />
      </svg>
